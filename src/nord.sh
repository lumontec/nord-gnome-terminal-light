...
# Repository: https://github.com/lumontec/nord-gnome-terminal
# License:    MIT
...
apply() {
  local \
    ...
    nord15="#8FBCBB"
  local \
    nord0_rgb="rgb(248,249,251)"
    nord1_rgb="rgb(236,239,244)"
    nord4_rgb="rgb(67, 76, 94)"
    nord8_rgb="rgb(94,129,172)"
...
NORD_PROFILE_VISIBLE_NAME="Nord-light"
log_level=2
